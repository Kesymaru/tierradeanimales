...
export const FLAG_CPUNTRIES: Array<FlagCountry> = [
...
export const GROUPED_COUNTRIES: Array<{
  label: string;
  options: Array<FlagCountry>;
}> = [
  {
    label: "Suggested",
    options: FLAG_CPUNTRIES.filter((c) => c.suggested),
  },
  {
